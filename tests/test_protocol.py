...
def make_protocol() -> Protocol:
    return Protocol(
        name="equipe_projet_test", author="test",
        time_step="semaine", L_crit=40.0,
        t_regulation_cible=2.0, delai_critique=3.0,
        proxies=[ProxySpec("L", "aucune tache", "charge critique", 0.1),
...
ROWS = [
    {"t": -1, "load": 0, "t_regulation": 0, "delai_signal_decision": 0,
     "irritant_severite": 0.1, "irritant_age": 4},
